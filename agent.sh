    ...
    "function": {
      ...
      "parameters": {
        ...
        "properties": {
          ...
          "content": {
            "type": "string",
            "description": "Unified diff to apply (mode=patch, default) or full file content (mode=write)"
          },
          "mode": {
            "type": "string",
            "enum": ["write", "patch"],
            "default": "patch",
            "description": "Write mode: 'patch' applies a unified diff incrementally (default); 'write' overwrites the entire file"
          }
        },
