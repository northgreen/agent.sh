...
TOOLS_JSON='[
  ...
  },
  {
    ...
    "function": {
      "name": "write",
      "description": "Write content to a file. Creates parent directories if needed. Has permission checks: system paths are denied, temp paths are auto-allowed, other paths require user confirmation. Returns byte count on success.",
      "parameters": {
        "type": "object",
        "properties": {
          "path": {
...
- write: Write content to a file (has permission checks)
